...
{
    public abstract class LegacyEnemyBehaviour : IDisposable
    {
        ...
        protected LegacyEnemyBehaviour(SubscribedProperty<EnemyState> enemyState, EnemyView view, PlayerController playerController, EnemyBehaviourConfig config)
        {
